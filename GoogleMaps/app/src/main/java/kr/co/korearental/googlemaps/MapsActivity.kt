package kr.co.korearental.googlemaps
...
import kr.co.korearental.googlemaps.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    fun updateLocation() {
        ...
        fusedLocationClient.requestLocationUpdates(locationRequest, locationCallback, //현재 위치 검색 API
                Looper.myLooper())
    }
