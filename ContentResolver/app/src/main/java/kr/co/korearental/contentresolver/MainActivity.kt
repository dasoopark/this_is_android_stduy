package kr.co.korearental.contentresolver
...
import kr.co.korearental.contentresolver.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {

    lateinit var storagePermission: ActivityResultLauncher<String> // 바뀐코드 =>ActivityResultLauncher
